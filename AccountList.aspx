<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AccountList.aspx.cs" Inherits="TalukderEngineering.AccountList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <asp:Button ID="btnAddProjectList" runat="server" Text="নতুন এ্যাকাউন্ট" OnClick="btnAddProjectList_Click" CssClass="button"  BackColor="#021e4a" Width="170px"/>
  </div>
   ...
   <div style="flex: 1 1 auto; overflow: hidden; display: flex; flex-direction: column; margin-top:20px; ">
          ...
          <Columns>
              ...
              <asp:BoundField DataField="AccountantAccess" HeaderText="এ্যাকাউন্টেন্ট এক্সেস" />
  ...
  <div id="popupOverlay" class="popup-overlay"></div>
      ...
      <div id="editPopup" class="popup">
          <h3  style="background-color:#021e4a; color:white; padding:10px; margin-bottom:20px; text-align:center;">এ্যাকাউন্টের তথ্য</h3>
          <asp:HiddenField ID="hfEditId" runat="server" />
          <div style="display:flex; justify-content:center; align-items:center;">
          <table style="margin:5px; text-align: left">
          
           <tr><td><label>এ্যাকাউন্টের নাম: </label></td>
          ...
          <tr><td><label>এ্যাকাউন্টেন্ট এক্সেস: </label></td><td>
      ...
      <div id="deletePopup" class="popup" style="text-align:center;">
          <h3  style="background-color:#021e4a; color:white; padding:10px; margin-bottom:20px; text-align:center;">এ্যাকাউন্টটি ডিলেট করতে চান?</h3>
