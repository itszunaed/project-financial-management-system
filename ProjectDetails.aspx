<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ProjectDetails.aspx.cs" Inherits="TalukderEngineering.Dashboard" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  z-index: 2000 !important;
    ...
    <asp:Label ID="lblProjectName" runat="server" Text="প্রোজেক্টের নাম: " Font-Size="16px" ForeColor="#33E8DC" /> <br />
    ...
    <table class="responsive-table">
        <tr>
            <!-- <td style="padding-bottom: 0px; "><asp:Label ID="lblTotalFunding" runat="server" Text="মোট প্রদান:" ForeColor="#33E8DC" Font-Size="17px"/></td> -->
            <td style="padding-bottom: 0px; "><asp:Label ID="lblTotalSpent" runat="server" Text="মোট খরচ:" ForeColor="#33E8DC"  Font-Size="20px"/></td>
           <!-- <td style="padding-bottom: 0px; "><asp:Label ID="lblAvailableAmount"  runat="server" Text="অবশিষ্ট:" ForeColor="#33E8DC"  Font-Size="17px"/></td> -->
        </tr>
...
<asp:Panel ID="pnlSearchSection" runat="server">
    ...
    <tr>
        ...
        <td style="padding:5px;"> <asp:DropDownList ID="ddlEntryPersonInDate" runat="server"  CssClass="custom-dropdown"></asp:DropDownList></td>
   ...
   <!-- <asp:Button ID="btnAddDeposit" runat="server" Text="জমা" CssClass="button" OnClientClick="passAddType('জমা');" OnClick="btnShowPopup_Click" BackColor="#349790" />
     <asp:Button ID="btnAddExpense" runat="server" Text="খরচ" CssClass="button" OnClientClick="passAddType('খরচ');" OnClick="btnShowPopup_Click" BackColor="#df202d" /> -->
        ...
        <div style="flex: 1 1 auto; overflow: hidden; display: flex; flex-direction: column;">
                ...
                <asp:GridView ID="gvProjectDetails" runat="server"  AutoGenerateColumns="false" DataKeyNames="Id" OnRowCommand="gvProjectDetails_RowCommand"  CssClass="table-style" GridLines="None">
            <Columns>
                <%--<asp:BoundField DataField="ProjectName" HeaderText="Project Name" /> --%>
                <asp:BoundField DataField="Date" HeaderText="তারিখ ও সময়" DataFormatString="{0:dd-MMM-yyyy<br/>hh:mm tt}" HtmlEncode="false" ItemStyle-Width="90px"/>
               ...
               <asp:TemplateField HeaderText="এমাউন্ট (৳)">
    <ItemTemplate>
        <%# String.Format(new System.Globalization.CultureInfo("hi-IN"), "{0:N0}", Eval("Amount")) %>
    </ItemTemplate>
</asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="একশন">
                    <ItemTemplate>
                        ...
                        <asp:Button ID="btnDelete" runat="server" Text="ডিলেট" CssClass="button actionbtn" BackColor="#FF4552" CommandName="DeleteRow" OnClientClick="saveGridScrollPosition()" CommandArgument='<%# Eval("Id") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
    ...
    <h3 style="background-color:#021e4a; color:white; padding:10px; margin-bottom:20px; text-align:center;">নতুন <span id="addTypeText"></span></h3>
    <div style="display:flex; justify-content:center; align-items:center;">
               <table style="margin:0px; text-align: center; width:100%;">
            <tr>
                <td><label>প্রোজেক্টের নাম: </label></td>
                <td>
                    <asp:TextBox ID="txtAddProjectName" runat="server" CssClass="custom-textbox"  ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td><label>এন্ট্রি করা ব্যক্তি: </label></td>
                <td>
                    <asp:TextBox ID="txtAddEnteredBy" runat="server" CssClass="custom-textbox" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width:130px;"><label id="lblAddExpenseCategory">খরচের খাত:</label></td>
                <td>
                    <asp:DropDownList ID="ddlAddExpenseCategory" runat="server" CssClass="custom-dropdown" ></asp:DropDownList>
                     <asp:TextBox ID="txtAddExpenseCategory" runat="server" CssClass="custom-textbox"  ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td><label>বর্ণনা: </label></td>
                <td>
                    <asp:TextBox ID="txtAddRemarks" runat="server" CssClass="custom-textbox" Height="60px"  TextMode="MultiLine" MaxLength="495" Font-Size="14px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td><label>এমাউন্ট (৳): </label></td>
                <td>
                    <asp:TextBox ID="txtAddAmount" runat="server" CssClass="custom-textbox"  MaxLength="10"></asp:TextBox>
                </td>
            </tr>
        </table>
        </div>
        ...
        <div style="text-align:center">
       <asp:Button ID="btnSaveAdd" runat="server" Text="সেভ"  CssClass="button" OnClientClick="return validate();" OnClick="btnSaveAdd_Click" BackColor="#0066FF" />

        <asp:Button ID="btnCancelAdd" runat="server" Text="বাতিল" CssClass="button" OnClientClick="hidePopup('addPopup'); return false;" BackColor="Red" />
    </div>
</div>
...
<script src="pdfMake/browser.js"></script>
    ...
    <script>
        ...
        function showAddPopup(type) {
            ...
            var txtAddExpenseCategory = document.getElementById('<%= txtAddExpenseCategory.ClientID %>');
            var ddlAddExpenseCategory = document.getElementById('<%= ddlAddExpenseCategory.ClientID %>');
        ...
        function validate() {
            var ddl = document.getElementById('<%= ddlAddExpenseCategory.ClientID %>');
            var type = document.getElementById('<%= hfAddType.ClientID %>');
        ...
        function generateBanglaPDF() {
           ...
           // ==========================
           let summaryText = "";
            summaryText = `খরচ: ${formatIndian(totalExpense)} ৳`;
           /*if (showOnlyExpense) {
