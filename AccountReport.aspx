<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AccountReport.aspx.cs" Inherits="TalukderEngineering.AccountReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  z-index: 2000 !important;
    ...
    <div class="selectproject-center">
        <asp:Label ID="lblSelectProjectName" runat="server" Text="এ্যাকাউন্ট:&nbsp;"></asp:Label>
    ...
    <asp:Label ID="lblProjectName" runat="server" Text="এ্যাকাউন্টের নাম: " Font-Size="16px" ForeColor="#33E8DC" /> <br />
    ...
    <table class="responsive-table">
        <tr>
            <!--<td style="padding-bottom: 0px; "><asp:Label ID="lblTotalFunding" runat="server" Text="ক্যাশ ইন:" ForeColor="#33E8DC" Font-Size="17px"/></td>-->
            <!--<td style="padding-bottom: 0px; "><asp:Label ID="lblTotalSpent" runat="server" Text="ক্যাশ আউট:" ForeColor="#33E8DC"  Font-Size="17px"/></td>-->
            <td style="padding-bottom: 0px; "><asp:Label ID="lblAvailableAmount"  runat="server" Text="ব্যালান্স:" ForeColor="#33E8DC"  Font-Size="20px"/></td>
        </tr>
...
<asp:Panel ID="pnlSearchSection" runat="server">
    ...
    <tr>
        ...
        <td style="padding:5px;"><asp:TextBox ID="txtEndDate" runat="server" TextMode="Date" CssClass="custom-dropdown"></asp:TextBox></td>
            ...
            <tr> <td style="min-width: 100px;"> <asp:Label ID="lblEntryPersonInDate" runat="server" Text="সম্পাদনকারী:" ></asp:Label> </td>
...
<td style="padding:5px;"> <asp:DropDownList ID="ddlProjectFilter" runat="server"   CssClass="custom-dropdown" ></asp:DropDownList></td>
  ...
  <td><asp:Label ID="lblTypeFilter" runat="server" Text="ধরণ:"></asp:Label></td>
<td style="padding:5px;"> <asp:DropDownList ID="ddlTypeFilter" runat="server"   CssClass="custom-dropdown" >
     <asp:ListItem Text="--None--" Value=""></asp:ListItem>
     <asp:ListItem Text="জমা" Value="জমা"></asp:ListItem>
    <asp:ListItem Text="প্রদান" Value="প্রদান"></asp:ListItem>
    <asp:ListItem Text="খরচ" Value="খরচ"></asp:ListItem>
    <asp:ListItem Text="ফেরত" Value="ফেরত"></asp:ListItem>
    ...
    <asp:Button ID="btnSearch" runat="server" Text="ফিল্টার" OnClick="btnSearch_Click" CssClass="button" BackColor="#2D5EDD" />
     <asp:Button ID="btnClear" runat="server" Text="ক্লিয়ার" CssClass="button" OnClick="btnClear_Click" BackColor="#681EF0" />
        ...
        <div style="flex: 1 1 auto; overflow: hidden; display: flex; flex-direction: column;">
              ...
              <asp:GridView ID="gvProjectDetails" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" OnRowCommand="gvProjectDetails_RowCommand" OnRowDataBound="gvProjectDetails_RowDataBound"
 CssClass="table-style" GridLines="None">
    <Columns>
        <asp:BoundField DataField="Date" HeaderText="তারিখ ও সময়" DataFormatString="{0:dd-MMM-yyyy<br/>hh:mm tt}" HtmlEncode="false" ItemStyle-Width="90px"/>
        
        <asp:BoundField DataField="TransactionBy" HeaderText="সম্পাদনকারী" />
    ...
    <ItemTemplate>
        ...
        <%-- New Balance Column --%>
        <asp:TemplateField HeaderText="ব্যালান্স (৳)">
    <ItemTemplate>
        ...
        <div id="editPopup" class="popup">
            ...
            <table style="margin:0px; text-align: center;">
                ...
                <tr><td><label>এ্যাকাউন্টের নাম: </label></td><td><asp:DropDownList ID="ddlEditAccount" runat="server" CssClass="custom-dropdown"/></td></tr>
            <tr> <td><asp:Label ID="lblEditDate" runat="server" Text="তারিখ: "></asp:Label></td>


            <td ><asp:TextBox ID="txtEditDate" runat="server"  CssClass="custom-dropdown datetime"></asp:TextBox></td>
            </tr>

             <tr><td><label>সম্পাদনকারী ব্যক্তি: </label></td><td><asp:TextBox ID="txtEditEnteredBy" runat="server" CssClass="custom-dropdown" ReadOnly="True" />
                 
              </td></tr>
            
                
            
             <tr><td><label>ধরণ: </label></td>
               
                 <td><asp:DropDownList ID="ddlType" runat="server" CssClass="custom-dropdown">
     
     <asp:ListItem Value="প্রদান">প্রদান</asp:ListItem>
     <asp:ListItem Value="খরচ">খরচ</asp:ListItem>
     <asp:ListItem Value="জমা">জমা</asp:ListItem>
     <asp:ListItem Value="ট্রান্সফার">ট্রান্সফার</asp:ListItem>
 </asp:DropDownList></td>
    ...
    <script>
        ...
        function generateBanglaPDF() {
            ...
            const headerRow = [
                ...
                { text: "সম্পাদনকারী", style: "tableHeader" },
                ...
                { text: "ব্যালান্স (৳)", style: "tableHeader" }
            ];
            ...
            rows.forEach(row => {
                ...
                const cashInText = cells[6].innerText.trim().replace(/[^\d.-]/g, '');
                const cashOutText = cells[7].innerText.trim().replace(/[^\d.-]/g, '');
            ...
            body.push([
                {
                    text:
                        `ক্যাশ ইন: ${formatIndian(totalIn)} ৳   |   ` +
                        `ক্যাশ আউট: ${formatIndian(totalOut)} ৳`,
                    colSpan: 9,
                    alignment: 'right',
                    bold: true,
                    margin: [0, 10, 0, 0],
    ...
    const appliedFilter =
            ...
            const docDefinition = {
                content: [
                    ...
                    { text: "এ্যাকাউন্ট রিপোর্ট", style: "subheader" },
...

                    {
                        table: {
                            ...
                            widths: [55, 'auto', 'auto', 'auto', '*', 'auto', 'auto', 'auto', 'auto'],
                            body: body
                        },
                        layout: {
                            hLineWidth: () => 0.5,
