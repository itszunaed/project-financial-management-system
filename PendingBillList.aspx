<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PendingBillList.aspx.cs" Inherits="TalukderEngineering.PendingBillList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:Button ID="btnAddProjectList" runat="server" Text="নতুন পেন্ডিং বিল" OnClick="btnAddProjectList_Click" CssClass="button"  BackColor="#021e4a" Width="170px"/>
 </div>
  ...
  <div style="flex: 1 1 auto; overflow: hidden; display: flex; flex-direction: column; margin-top:20px; ">
         ...
         <Columns>
             <asp:BoundField DataField="Title" HeaderText="টাইটেল" />
             
             <asp:BoundField DataField="Remarks" HeaderText="বিবরণ" />
 ...
 <div id="popupOverlay" class="popup-overlay"></div>
     ...
     <div id="editPopup" class="popup">
         <h3  style="background-color:#021e4a; color:white; padding:10px; margin-bottom:20px; text-align:center;">পেন্ডিং বিলের তথ্য</h3>
         <asp:HiddenField ID="hfEditId" runat="server" />
         <div style="display:flex; justify-content:center; align-items:center;">
         <table style="margin:5px; text-align: left">
         
          <tr><td><label>টাইটেল: </label></td>
             <td><asp:TextBox ID="txtProjectName" runat="server" CssClass="custom-textbox" Width="250px" MaxLength="95" TextMode="MultiLine" Height="40px"  Wrap="True"></asp:TextBox></td></tr>

         <tr><td><label>বিবরণ: </label></td><td><asp:TextBox ID="txtProjectArea" runat="server" CssClass="custom-textbox" Width="250px" TextMode="MultiLine" Height="40px" MaxLength="245" Wrap="True" /></td></tr>
